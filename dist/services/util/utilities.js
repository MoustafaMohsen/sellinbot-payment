            ...
            return __generator(this, function (_a) {
                return [2, new Promise(function (resolve, reject) {
                        try {
                            ...
                            log && console.log("httpRequest options: ".concat(JSON.stringify(options)));
                            var req = https_1.default.request(options, function (res) {
                                ...
                                res.on('end', function () {
                                    ...
                                    log && console.log("httpRequest response: ".concat(JSON.stringify(response)));
